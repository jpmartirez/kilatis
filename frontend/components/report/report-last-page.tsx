          ...
          <div className="space-y-2">
            <label className="flex items-start gap-2.5 cursor-pointer">
              ...
              <span className="text-slate-800 font-medium text-[11px] leading-snug">
                I certify that I have reviewed the automated findings above against the source evidence file.{" "}
            ...
            <label className="flex items-start gap-2.5 cursor-pointer">
              ...
              />
              <span className="text-slate-800 font-medium text-[11px] leading-snug">
                I acknowledge that this report accurately reflects the KILATIS system output at the time of analysis.{" "}
                <span className="text-red-500 font-bold">*Required</span>
              </span>
            </label>
          </div>
